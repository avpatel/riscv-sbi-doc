...
* `a7` (or `t0` on RV32E-based systems) encodes the SBI extension ID (*EID*),
  which matches how the system call ID is encoded in the standard UNIX system
  call ABI.
...
| SBI_PMU_HW_REF_CPU_CYCLES          |         10 | Event for each reference
                                                    CPU cycle
| SBI_PMU_HW_MISALIGNED_LOAD         |         11 | Event for misaligned
                                                    load instruction
| SBI_PMU_HW_MISALIGNED_STORE        |         12 | Event for misaligned
                                                    store instruction
|===
...
| SBI_PMU_SW_MISALIGNED_LOAD           |          0 | Misaligned load trap
                                                      event
| SBI_PMU_SW_MISALIGNED_STORE          |          1 | Misaligned store trap
                                                      event
| SBI_PMU_SW_ACCESS_LOAD               |          2 | Load access trap event
| SBI_PMU_SW_ACCESS_STORE              |          3 | Store access trap event
| SBI_PMU_SW_ILLEGAL_INSN              |          4 | Illegal instruction
                                                      trap event
| SBI_PMU_SW_SET_TIMER                 |          5 | Set timer event
| SBI_PMU_SW_IPI_SENT                  |          6 | Sent IPI to other
                                                      HART event
| SBI_PMU_SW_IPI_RECEIVED              |          7 | Received IPI from other
                                                      HART event
| SBI_PMU_SW_FENCE_I_SENT              |          8 | Sent FENCE.I request to
                                                      other HART event
| SBI_PMU_SW_FENCE_I_RECEIVED          |          9 | Received FENCE.I request
                                                      from other HART event
| SBI_PMU_SW_SFENCE_VMA_SENT           |         10 | Sent SFENCE.VMA request
                                                      to other HART event
| SBI_PMU_SW_SFENCE_VMA_RECEIVED       |         11 | Received SFENCE.VMA
                                                      request from other
                                                      HART event
| SBI_PMU_SW_SFENCE_VMA_ASID_SENT      |         12 | Sent SFENCE.VMA with
                                                      ASID request to other
                                                      HART event
| SBI_PMU_SW_SFENCE_VMA_ASID_RECEIVED  |         13 | Received SFENCE.VMA with
                                                      ASID request from other
                                                      HART event
| SBI_PMU_SW_HFENCE_GVMA_SENT          |         14 | Sent HFENCE.GVMA request
                                                      to other HART event
| SBI_PMU_SW_HFENCE_GVMA_RECEIVED      |         15 | Received HFENCE.GVMA
                                                      request from other
                                                      HART event
| SBI_PMU_SW_HFENCE_GVMA_VMID_SENT     |         16 | Sent HFENCE.GVMA with
                                                      VMID request to other
                                                      HART event
| SBI_PMU_SW_HFENCE_GVMA_VMID_RECEIVED |         17 | Received HFENCE.GVMA
                                                      with VMID request from
                                                      other HART event
| SBI_PMU_SW_HFENCE_VVMA_SENT          |         18 | Sent HFENCE.VVMA request
                                                      to other HART event
| SBI_PMU_SW_HFENCE_VVMA_RECEIVED      |         19 | Received HFENCE.VVMA
                                                      request from other
                                                      HART event
| SBI_PMU_SW_HFENCE_VVMA_ASID_SENT     |         20 | Sent HFENCE.VVMA with
                                                      ASID request to other
                                                      HART event
| SBI_PMU_SW_HFENCE_VVMA_ASID_RECEIVED |         21 | Received HFENCE.VVMA
...
=== Function: Read a software counter (FID #3)
